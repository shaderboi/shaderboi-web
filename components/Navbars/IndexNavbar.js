      ...
      <nav
        ...
        <div className="container px-4 mx-auto flex flex-wrap items-center justify-between">
          <div className="w-full relative flex justify-between lg:w-auto lg:static lg:block lg:justify-start">
            <Link href="/">
              <a href="/">
                <img className="h-12 inline-block object-scale-down" src="/img/logo.png"></img>
                <p
                  className="ml-3 inline-block text-blueGray-700 text-sm font-bold leading-relaxed inline-block mr-4 py-2 whitespace-nowrap"
                >
                  Shaderboi
                </p>
              </a>
