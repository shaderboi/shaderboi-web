        ...
        html! {
            <div class="container-base container-middle-primary">
                <div class="text-on-background-primary container-content-center container-clamp-width">
                    <h1 class="text-vspacing">{"Privacy & Policy"}</h1>
                    ...
                    <h2 class="text-vspacing">{"Non-personal identification information"}</h2>
                    ...
                    <h2 class="text-vspacing">{"How we use the information collected"}</h2>
                    ...
                    <h2 class="text-vspacing">{"To make our service better"}</h2>
                    ...
                    <h2 class="text-vspacing">{"How we protect your information"}</h2>
                    ...
                    <h2 class="text-vspacing">{"Sharing your personal information"}</h2>
                    ...
                    <h2 class="text-vspacing">{"Advertising"}</h2>
                    ...
                    <h2 class="text-vspacing">{"Compliance with children's online privacy protection measures"}</h2>
                    ...
                    <h2 class="text-vspacing">{"Changes to this site's privacy policy"}</h2>
                    ...
                    <h2 class="text-vspacing">{"Your acceptance of these terms"}</h2>
                    ...
                    <h2 class="text-vspacing">{"According to the Data Protection Regulation data subjects have the right to"}</h2>
