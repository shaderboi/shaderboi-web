      ...
      <section className="mt-48 md:mt-40 pb-40 relative bg-blueGray-100">
        ...
        <div className="justify-center text-center flex flex-wrap mt-24">
          <div className="w-full md:w-6/12 px-12 md:px-4">
            <h2 className="font-semibold text-4xl">Our Portfolios</h2>
            <p className="text-lg leading-relaxed mt-4 mb-4 text-blueGray-500">
              We are experienced in creating an interactive application
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="bg-blueGray-600">
        <div className="container mx-auto pb-64">
          <div className="flex flex-wrap justify-center">
            ...
            {/*  <i*/}
            {/*    className="fab fa-github text-blueGray-700 absolute text-55 -top-150-px -right-100 left-auto opacity-80"></i>*/}
            {/*</div>*/}
          </div>
        </div>
      </section>
